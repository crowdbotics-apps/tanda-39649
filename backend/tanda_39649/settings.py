"""
Django settings for tanda_39649 project.
...
WSGI_APPLICATION = 'tanda_39649.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tanda_39649 API",
    "DESCRIPTION": "API documentation for tanda_39649 App",
    "VERSION": "v1",
}
